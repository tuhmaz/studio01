-- ============================================================
-- Final Database Schema for Hausmeister Pro
-- Compatible with restricted PostgreSQL user (no superuser needed)
-- Run this script to completely initialize or reset the database structure
-- ============================================================
...
-- 4. JOB ASSIGNMENTS (Tasks / Shifts)
...
-- 6. WORK LOG ENTRIES (Photos, text notes, voice notes)
...
-- Default admin seed removed. Create admin credentials on the server only.
-- ============================================================
